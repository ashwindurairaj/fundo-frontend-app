...
import { NoteService} from "../services/note.service";// ✅ Service to fetch notes
import { Note,NoteActionType } from '../models/note'; // ✅ Note model interface
import { SearchNotesPipe} from "../shared/pipes/search-notes.pipe";
